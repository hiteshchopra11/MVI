package com.example.mvi.ui.main.view
...
import com.example.mvi.ui.main.adapter.MainAdapter
import com.example.mvi.ui.main.intent.MainIntent
import com.example.mvi.ui.main.viewmodel.MainViewModel
    ...
    private fun observeViewModel() {
        lifecycleScope.launch {
            mainViewModel.state.collect{
                when (it) {
                    is MainStateIntent.Idle -> {

                    }
                    is MainStateIntent.Loading -> {
                        buttonFetchUser.visibility = View.GONE
                        progressBar.visibility = View.VISIBLE
                    }

                    is MainStateIntent.Users -> {
                        progressBar.visibility = View.GONE
                        buttonFetchUser.visibility = View.GONE
                        renderList(it.user)
                    }
                    is MainStateIntent.Error -> {
                        progressBar.visibility = View.GONE
